...
Este repositorio contiene la implementación de controladores para un robot móvil en el simulador **Webots**. El objetivo es demostrar cuatro tipos de movimientos fundamentales utilizando lógica de programación en Python.
